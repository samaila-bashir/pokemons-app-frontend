...
const authReducer = (
    ...
    switch (action.type) {
        ...
        case LoginActions.LOGIN_SUCCESSFUL: {
            state = {...state, loginStatus: LoginActions.LOGIN_SUCCESSFUL, loginError: "", token: action.payload.token}
        ...
        case SignupActions.SIGNUP_SUCCESSFUL: {
            state = {...state, signupStatus: SignupActions.SIGNUP_SUCCESSFUL, signupError: "", token: action.payload.token}
